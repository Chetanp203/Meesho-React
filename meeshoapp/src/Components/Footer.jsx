...
const Footer = () => {
  return (
    ...
    <div id="footer" className="flex">
      ...
      <div>
        <h2>Shop Nonstop On Meesho</h2>
        <p>Trusted by more than one crore Indians</p>
      ...
      <div>
        <p><b>Legal and Policies</b></p>
        <p><b>Meesho Tech Blog</b></p>
        <p><b>Notices and Returns</b></p>
      </div>
      <div>
        <p><b>Reach Out To Us</b></p>
        <div className="flex mxy">
          <i className="fa-brands fa-facebook fa-xl" style={{ color: '#2cace2',paddingRight:'10px' }}></i>
          <i className="fa-brands fa-instagram fa-xl" style={{ color: '#f20d0d',paddingRight:'10px' }}></i>
          <i className="fa-brands fa-youtube fa-xl" style={{ color: '#ff2929',paddingRight:'10px' }}></i>
          <i className="fa-brands fa-linkedin fa-xl" style={{ color: '#2a7aac',paddingRight:'10px' }}></i>
          <i className="fa-brands fa-twitter fa-xl" style={{ color: '#10accb' }}></i>
