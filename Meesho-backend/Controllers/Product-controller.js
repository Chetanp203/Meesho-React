...
export const getYourProducts= async (req,res)=>{
    try{
     ...
     if(!decodedData){
      ...
      const yourProductData = await Productmodel.find({userId:userId})
...
export const addRating=async(req,res)=>{
    try{
        ...
        const updatedProductRating = await Productmodel.findByIdAndUpdate(productId, { $push: { ratings: rating } }, { new: true })
